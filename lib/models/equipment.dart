...
class Equipment {
  ...
  factory Equipment.fromJson(Map<String, dynamic> json) {
    ...
    return Equipment(
      ...
      slot: parseEnum(EquipmentSlot.values, json['slot'] as String?,
          EquipmentSlot.weapon),
      rarity: parseEnum(EquipmentRarity.values, json['rarity'] as String?,
          EquipmentRarity.common),
...
class EquipmentFactory {
  static const _weaponNames = {
    EquipmentRarity.common: ['Adaga Enferrujada', 'Lança Simples', 'Machado Cru', 'Faca de Osso'],
    EquipmentRarity.uncommon: ['Espada Curta', 'Lança Reforçada', 'Machado Afiado', 'Punho de Ferro'],
    EquipmentRarity.rare: ['Espada Longa', 'Alabarda', 'Machado de Guerra', 'Garra Dupla'],
    EquipmentRarity.epic: ['Lâmina Espectral', 'Fauces do Abismo', 'Ceifadora', 'Punho do Trovão'],
    EquipmentRarity.legendary: ['Espada da Torre', 'Lança do Primordial', 'Machado do Fim', 'Garra Dimensional'],
  };

  static const _armorNames = {
    EquipmentRarity.common: ['Couro Batido', 'Vestes Rasgadas', 'Placa Simples', 'Malha Tosca'],
    EquipmentRarity.uncommon: ['Couro Reforçado', 'Cota de Malha', 'Placa de Ferro', 'Escama de Réptil'],
    EquipmentRarity.rare: ['Armadura de Aço', 'Malha Élfica', 'Placa Gravada', 'Escama Antiga'],
    EquipmentRarity.epic: ['Armadura Abissal', 'Cota Espectral', 'Placa do Guardião', 'Casca do Leviatã'],
    EquipmentRarity.legendary: ['Armadura da Torre', 'Escudo Primordial', 'Placa Dimensional', 'Couraça do Abyss'],
  };

  static const _accessoryNames = {
    EquipmentRarity.common: ['Amuleto de Osso', 'Anel de Cobre', 'Colar de Pedra', 'Bracelete Rústico'],
    EquipmentRarity.uncommon: ['Amuleto de Prata', 'Anel Rúnico', 'Colar de Cristal', 'Bracelete Entalhado'],
    EquipmentRarity.rare: ['Amuleto Arcano', 'Anel de Poder', 'Colar da Visão', 'Bracelete Etéreo'],
    EquipmentRarity.epic: ['Amuleto do Vazio', 'Anel do Destino', 'Colar do Abyss', 'Bracelete Espectral'],
    EquipmentRarity.legendary: ['Amuleto Primordial', 'Anel da Torre', 'Colar Dimensional', 'Selo do Escolhido'],
  };

  static const _descriptions = {
    EquipmentSlot.weapon: 'Forjado nas profundezas da Torre. Cada cicatriz conta uma batalha.',
    EquipmentSlot.armor: 'Proteção extraída dos andares conquistados. Absorve o peso do destino.',
    EquipmentSlot.accessory: 'Ressonância com a energia da Torre. Amplifica o potencial oculto.',
  };
  ...
  static ({double iron, double knowledge, double stone}) craftCost(
      EquipmentRarity rarity) =>
      switch (rarity) {
        EquipmentRarity.common => (iron: 5.0, knowledge: 0.0, stone: 0.0),
        EquipmentRarity.uncommon => (iron: 12.0, knowledge: 5.0, stone: 0.0),
        EquipmentRarity.rare => (iron: 25.0, knowledge: 15.0, stone: 10.0),
        EquipmentRarity.epic => (iron: 50.0, knowledge: 35.0, stone: 25.0),
        EquipmentRarity.legendary => (iron: 100.0, knowledge: 80.0, stone: 50.0),
      };
}